...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self=[super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _url=[[UIImageView alloc]init];
        //_avatar_url.layer.cornerRadius=1;
        //_avatar_url.layer.masksToBounds=YES;
        ...
        _dianzan.sd_layout
        .topSpaceToView(self.url,20)
        .leftEqualToView(self.url)
        .widthIs(30)
        .heightIs(30);
        
        
        _digg_count.sd_layout
        .topSpaceToView(self.url,30)
...
-(void)setModel:(TupianData *)model{
    ...
    [self.url sd_setImageWithURL:[NSURL URLWithString:model.avatar_url] placeholderImage:[UIImage imageNamed:@""]];
