...
#define URL @"http://lf.snssdk.com/neihan/stream/mix/v1/?content_type=-102&iid=7831664713&os_version=10.1.1&os_api=18&app_name=joke_essay&channel=App%20Store&device_platform=iphone&idfa=A8B345AC-7EBC-4464-B2C0-EC889FD37D8F&live_sdk_version=130&vid=3B2D8102-C5C6-4E4E-88DF-42258735B785&openudid=3ae393518bfd684561672e585ba5c7cfb238b9ab&device_type=iPhone9,1&version_code=6.0.0&ac=WIFI&screen_width=750&device_id=35025040258&aid=7&content_type=-102&count=30&double_col_mode=0&essence=1&message_cursor=0&min_time=1487294816&mpic=1"


@interface Duanzi ()<UITableViewDelegate,UITableViewDataSource>
...
-(void)getUrlData{
    ...
    [manager GET: URL parameters:nil progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        for (NSDictionary*dic in array1) {
            ...
            DuanziData*model=[[DuanziData alloc]init];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DuanziTableViewCell*cell=[tableView dequeueReusableCellWithIdentifier:str];
    if (!cell) {
        cell=[[DuanziTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:str];
    }
